...
/*
Si ya estás logueado, manda directo al dashboard.
Esto usa la misma lógica de tu config/auth.php:
user_id + logged_in === true
*/
if (
    ...
    if (!$username || !$password) {
        ...
        try {
            ...
            if (!$user) {
                ...
                // Compatibilidad por si algún usuario viejo usa columna password
                if (isset($user["password"]) && password_verify($password, $user["password"])) {
                    $validPassword = true;
                }

                // Compatibilidad temporal si algún usuario viejo tiene password plano
                ...
                if ($validPassword) {
                    ...
                    /*
                    IMPORTANTE:
                    Tu config/auth.php exige logged_in === true.
                    Sin esto, index_v5.php te devuelve al login.
                    */
                    $_SESSION["logged_in"] = true;
...
<div class="login-page">
    ...
    <section class="login-card">
        ...
        <div class="login-box">
            ...
            <?php if($registered || $success === 'registered'): ?>
            <div class="success-box">Cuenta creada correctamente. Ya puedes iniciar sesión ✅</div>
            <?php endif; ?>

            <?php if($success === 'reset'): ?>
            <div class="success-box">Contraseña actualizada correctamente. Ya puedes iniciar sesión ✅</div>
            <?php endif; ?>
